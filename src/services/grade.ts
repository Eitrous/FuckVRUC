...
const GRADE_API_URL =
  "https://jw.ruc.edu.cn/resService/jwxtpt/v1/xsd/cjgl_xsxdsq/findKccjList?resourceCode=XSMH0526&apiCode=jw.xsd.xsdInfo.controller.CjglKccjckController.findKccjList";
...
function isSummaryRow(item: any) {
  return (
    parseNumber(item?.sumxf) !== undefined ||
    parseNumber(item?.sumxfjd) !== undefined
  );
}
